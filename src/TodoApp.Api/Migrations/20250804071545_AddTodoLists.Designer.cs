...
namespace TodoApp.Api.Migrations
{
    ...
    [Migration("20250804071545_AddTodoLists")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoApp.Api.Data.Models.TodoList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("ix_todo_lists_is_deleted");

                    b.HasIndex("TeamId")
                        .HasDatabaseName("ix_todo_lists_team_id");
            ...
            modelBuilder.Entity("TodoApp.Api.Data.Models.TodoList", b =>
                {
                    b.HasOne("TodoApp.Api.Data.Models.Team", "Team")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_todo_lists_teams_team_id");
